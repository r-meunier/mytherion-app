...
describe('Frontend UI routes manifest', () => {
  ...
  it('generates project scoped routes correctly', () => {
    ...
    expect(projectRoutes.codex.detail('entity-456')).toBe('/projects/proj-123/codex/entity-456');
    expect(projectRoutes.codex.edit('entity-456')).toBe('/projects/proj-123/codex/entity-456/edit');
...
describe('Backend API apiRoutes manifest', () => {
  ...
  it('generates project and entity API endpoints with dynamic IDs', () => {
    ...
    expect(apiRoutes.entities.list('proj-1')).toBe('/api/projects/proj-1/entities');
    expect(apiRoutes.entities.create('proj-1')).toBe('/api/projects/proj-1/entities');
    expect(apiRoutes.entities.detail('proj-1', 'ent-2')).toBe('/api/projects/proj-1/entities/ent-2');
    expect(apiRoutes.entities.image('proj-1', 'ent-2')).toBe('/api/projects/proj-1/entities/ent-2/image');
  });

  it('generates dashboard, category, and storage endpoints', () => {
    ...
    expect(apiRoutes.categories.list('proj-1')).toBe('/api/projects/proj-1/categories');

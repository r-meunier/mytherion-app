...
import { entityTypeConfig } from '@/app/components/codex/EntityTypeSelector';
import DualSidebar from '@/app/components/DualSidebar';
import AppHeader from '@/app/components/AppHeader';
import Link from 'next/link';
import EntityMetadataEditor from '@/app/components/codex/metadata/EntityMetadataEditor';
import ComponentDispatcher from '@/app/components/codex/metadata/ComponentDispatcher';
...
export default function EntityDetailPage() {
  ...
  const handleEdit = () => {
    router.push(routes.project(projectId).codex.edit(entityId));
  };
